...
import { projectSave, projectList, projectResume, projectAnalysisGet, artifactSave, artifactList, artifactGet, artifactDelete, artifactRestore, artifactArchived, artifactVersions, artifactRollback, search, importAnalyze, importSeed, } from '../tools/index.js';
/**
 ...
 */
const TOOL_HANDLERS = {
    project_save: (ctx, params) => projectSave(ctx, params),
    project_list: (ctx, params) => projectList(ctx, params),
    project_resume: (ctx, params) => projectResume(ctx, params),
    project_analysis_get: (ctx, params) => projectAnalysisGet(ctx, params),
    artifact_save: (ctx, params) => artifactSave(ctx, params),
    artifact_list: (ctx, params) => artifactList(ctx, params),
    artifact_get: (ctx, params) => artifactGet(ctx, params),
    artifact_delete: (ctx, params) => artifactDelete(ctx, params),
    artifact_restore: (ctx, params) => artifactRestore(ctx, params),
    artifact_archived: (ctx, params) => artifactArchived(ctx, params),
    artifact_versions: (ctx, params) => artifactVersions(ctx, params),
    artifact_rollback: (ctx, params) => artifactRollback(ctx, params),
    search: (ctx, params) => search(ctx, params),
    import_analyze: (ctx, params) => importAnalyze(ctx, params),
    import_seed: (ctx, params) => importSeed(ctx, params),
};
/**
